...
use crate::{
    call_execute, call_instantiate, call_migrate, call_reply, symb_exec::{ProfileEvaluator, ProfileGenerator}, testing::{mock_info, ConcurrentStorage, StorageWrapper}, vm_manager::sc_storage::ConcurrentTimer, BackendApi, ContractRWS, Instance, Querier, ReadWrite, VMManager
};
...
pub struct SerializableTransaction {
    ...
    pub rws: Vec<SerializableContractRWS>,
}

#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, Eq)]
pub struct SerializableContractRWS {
    contract_addr: String,
    rws: Vec<OperationType>,
}
